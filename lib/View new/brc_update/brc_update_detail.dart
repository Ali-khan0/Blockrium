...
class BRCDetailPageNew extends StatefulWidget {
  const BRCDetailPageNew({
    Key? key,
    required this.image,
    required this.title,
    required this.date,
  ...
  @override
  State<BRCDetailPageNew> createState() => _BRCDetailPageNewState();
}
...
class _BRCDetailPageNewState extends State<BRCDetailPageNew> {
  @override
  void initState() {
    super.initState();
    // initializeBannerAds();
